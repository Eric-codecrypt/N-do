...
<body>
<div class="wrapper">
    <div  id="welcome-message" class="glitch" data-text=""></div>
    <div id="question-container">
        <p id="question-text" class="glitch" data-text=""></p>
        <div id="input-container">
            <p id="input-prompt" class="glitch" data-text=""></p>
            ...
            <div class="button-container" id="button-container" style="display: none;">
                <p id="choice-question" class="glitch" data-text=""></p>
        ...
        function typeWriter(element, text, speed, callback) {
            ...
            function type() {
                if (i < text.length) {
                    ...
                    // Atualiza o atributo data-text junto com o texto
        ...
        function handleEnterPress() {
            ...
            switch (currentStep) {
                case 'name':
                    ...
                    const choiceQuestion = document.getElementById('choice-question');
                    typeWriter(choiceQuestion, `${icons.welcome} Olá, ${value}! Escolha sua próxima ação:`, 15, function() {
                ...
                case 'reg-username':
                    ...
                    clearAll();
                    typeWriter(questionText, `${icons.email} Agora precisamos do seu email para contato`, 13, function() {
                        typeWriter(inputPrompt, 'Digite um email válido:', 20, function() {
                            showCursor();
                            showInput();
                            currentInput.type = 'text';
                ...
                case 'reg-email':
                    ...
                    clearAll();
                    typeWriter(questionText, `${icons.password} Última etapa: Crie uma senha super segura!`, 13, function() {
                        typeWriter(inputPrompt, 'Sua senha (mín. 8 chars, maiúscula, número):', 20, function() {
                            showCursor();
                            showInput();
                ...
                case 'login-email':
                    ...
                    clearAll();
                    typeWriter(questionText, `${icons.password} Digite sua senha para acessar`, 13, function() {
                        typeWriter(inputPrompt, 'Senha:', 20, function() {
                            showCursor();
                            showInput();
                            currentInput.type = 'password';
...
// Função que processa o registro do usuário
        function processRegistration() {
            ...
            typeWriter(commandLine, `${icons.loading} Iniciando processo de registro...`, 18, function() {
                    ...
                    .then(data => {
                        if (data.success) {
                            setTimeout(() => {
                                ...
                                typeWriter(commandLine, `${icons.user} Criando seu perfil personalizado...`, 15, function() {
                                    setTimeout(() => {
                                        commandLine.innerHTML = '';
                                        commandLine.appendChild(progress.container);
                                        progress.fill.style.width = '80%';
                                        typeWriter(commandLine, `${icons.secure} Configurando ambiente e segurança...`, 15, function() {
                                            setTimeout(() => {
                                                commandLine.innerHTML = '';
                                                commandLine.appendChild(progress.container);
                                                progress.fill.style.width = '100%';
                                                typeWriter(commandLine, `${icons.success} Registro concluído! Agora faça login com suas credenciais.`, 13, function() {
                                                    commandLine.style.display = 'none';
                                                    ...
                                                    setTimeout(() => {
                                                        ...
                                                        clearAll();
                                                        typeWriter(questionText, `${icons.info} Redirecionando para login...`, 13, function() {
                                                            setTimeout(() => {
                                                                clearAll();
                                                                typeWriter(questionText, `${icons.email} Email: ${userData.email}`, 20, function() {
                                                                    typeWriter(inputPrompt, 'Digite sua senha:', 20, function() {
                                                                        showCursor();
                                                                        showInput();
                                                                        currentInput.type = 'password';
                                                                        currentStep = 'login-password';
        ...
        function processLogin() {
            ...
            const progress = createProgressBar();
            commandLine.appendChild(progress.container);
            typeWriter(commandLine, `${icons.loading} Verificando suas credenciais...`, 18, function() {
                    ...
                    .then(data => {
                        if (data.success) {
                            setTimeout(() => {
                                ...
                                typeWriter(commandLine, `${icons.secure} Autenticação confirmada! Carregando perfil...`, 15, function() {
                                    setTimeout(() => {
                                        commandLine.innerHTML = '';
                                        commandLine.appendChild(progress.container);
                                        progress.fill.style.width = '100%';
                                        typeWriter(commandLine, `${icons.success} Acesso ${data.data?.username ? ', ' + data.data.username : ''}! Bem-vindo de volta!`, 13, function() {
                                            commandLine.style.display = 'none';
                                            clearAll();
                                            showNotification(`${icons.success} ${data.message || "Operação realizada com sucesso!"}`);
                                            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    animateLoadingDots(function() {
                        typeWriter(inputPrompt, `${icons.success} Sistema pronto! Vamos criar sua conta`, 60, function() {
                            setTimeout(() => {
                                clearAll();
                                typeWriter(questionText, `${icons.user} Primeiro, escolha seu nome de usuário único`, 13, function() {
                                    typeWriter(inputPrompt, 'Nome de usuário (3+ chars, sem espaços):', 20, function() {
                                        showCursor();
                                        showInput();
                ...
                setTimeout(() => {
                    ...
                    animateLoadingDots(function() {
                        typeWriter(inputPrompt, `${icons.welcome} Sistema carregado! Bem-vindo de volta`, 60, function() {
                            setTimeout(() => {
                                clearAll();
                                typeWriter(questionText, `${icons.email} Digite seu email para continuar`, 13, function() {
                                    typeWriter(inputPrompt, 'Email:', 20, function() {
                                        showCursor();
                                        showInput();
        ...
        // Iniciar a aplicação
        typeWriter(welcomeMessage, `${icons.welcome} Bem-vindo ao N-Project (Nōdo) - O TaskBoard preferido por desenvolvedores!`, 18, function () {
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    typeWriter(questionText, `${icons.user} Para começar, como posso te chamar?`, 13, function () {
                        typeWriter(inputPrompt, 'Seu nome:', 20, function () {
                            showCursor();
                            showInput();
                            currentStep = 'name';
                        });
